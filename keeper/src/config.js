...
function loadConfig() {
  ...
  return {
    ...
    resolverPluginConfigPath: process.env.RESOLVER_PLUGIN_CONFIG_PATH || './plugins.json',
    resolverTimeoutMs: parseInteger(process.env.RESOLVER_TIMEOUT_MS, 5000),
    resolverMaxConcurrent: parseInteger(process.env.RESOLVER_MAX_CONCURRENT, 5),
