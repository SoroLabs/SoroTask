...
export default function Home() {
  return (
    // WalletProvider must wrap everything that needs wallet state.
    // It is a Client Component boundary — page.tsx itself stays a Server Component.
    <WalletProvider>
      <div className="min-h-screen bg-neutral-900 text-neutral-100 font-sans">
        ...
        <main className="container mx-auto px-6 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {/* Create Task Section — gated behind wallet connection */}
            <section className="space-y-6">
              <h2 className="text-2xl font-bold">Create Automation Task</h2>
              <WalletGate message="Connect your Freighter wallet to register a new automation task.">
